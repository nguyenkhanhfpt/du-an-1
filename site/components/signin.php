<div class="container">
    ...
    <form class="w-50 mx-auto form">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Your name" name="name_customer">
        </div>
        <div class="form-group">
            ...
            <div class="row">
                <div class="col">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="customRadioInline1" name="gender" value="Nam" class="custom-control-input">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" placeholder="Password again" name="password">
                    </div>
                </div>
            </div>
        </div>
